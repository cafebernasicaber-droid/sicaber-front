...
/**
 * Overlay de transición de página: difumina/oscurece el fondo y muestra
 * una taza de café animada mientras se completa una acción (login,
 * registro, verificación, navegación, etc).
 *
 ...
 *
 * Antes también barría una cortina diagonal verde (`.pto__panel`); se
 * quitó para dejar únicamente la taza.
 */
