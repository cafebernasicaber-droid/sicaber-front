...
const LoginPage = () => {
  ...
  if (r.success) navigate(r.redirectTo || '/admin'); // '/admin' -> HomeRedirect (primer módulo con permiso)
          ...
          <form onSubmit={handleSubmit} className="adm-form">
            <div className="adm-field">
              ...
              <div className="adm-input-wrap">
                ...
                <input type="text" placeholder="Usuario o correo" autoComplete="username" value={username} onChange={e => setUsername(e.target.value)}/>
              </div>
            </div>
            <div className="adm-field">
              ...
              <div className="adm-input-wrap">
                ...
                <input type={showPass?'text':'password'} placeholder="Tu contraseña" autoComplete="current-password" value={password} onChange={e => setPassword(e.target.value)}/>
