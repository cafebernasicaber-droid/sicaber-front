    ...
    <Layout>
      <div className="insumos-root">
        ...
        <div className="insumos-toolbar">
          ...
          {(query || estadoFiltro !== 'Todos') && (
            <button className="btn-limpiar-filtros" title="Limpiar filtros"
              onClick={() => { setQuery(''); setEstadoFiltro('Todos'); setPage(1); }}>
              ✕ Limpiar filtros
            </button>
          )}
        ...
        <div className="insumos-card">
          {shown.length === 0 ? (
            <div className="empty-state">
              ...
              {!query && hasPermiso('adiciones', 'crear') && <button className="btn-add-first" onClick={() => setModal('new')}>Nueva adición</button>}
            </div>
          ) : (
            <>
                      ...
                      <tr key={a.id}>
                        ...
                        <td>
                          {hasPermiso('adiciones', 'editar') ? (
                            ...
                            <span className={`toggle-btn ${a.estado === 'Activo' ? 'toggle-on' : 'toggle-off'}`} style={{cursor:'default',opacity:0.6}}><span className="toggle-thumb"/></span>
                          )}
                        </td>
                        <td>
                          <div className="actions-group">
                            {hasPermiso('adiciones', 'ver') && (
                            ...
                            {hasPermiso('adiciones', 'eliminar') && <AnularButton onClick={() => setDelAdic(a)}/>}
                          </div>
                        </td>
                      </tr>
                    ))}
