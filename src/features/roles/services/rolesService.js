...
const MODULOS_PERMISOS = [
  ...
  // "Locales" (tabla `locales`, distinta de `sede`) — el backend ya exige
  // estos 4 permisos en /api/locales (ver requierePermiso en
  // sicaber-back-main), pero no estaban en esta lista, así que ningún rol
  // personalizado podía recibirlos desde el formulario de Roles (solo
  // Administrador los tiene, sincronizados aparte — ver
  // sincronizarPermisosLocalesAdmin en el backend).
  { modulo: 'Locales',      permisos: [{ id:'ver_locales',      label:'Ver' },{ id:'crear_locales',    label:'Crear'},{ id:'editar_locales',    label:'Editar'},{ id:'eliminar_locales',    label:'Eliminar'}] },
