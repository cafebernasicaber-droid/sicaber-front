        ...
        <div className="insumos-card">
          {shown.length === 0 ? (
            <div className="empty-state">
              ...
              {!hayFiltros && hasPermiso('combos', 'crear') && <button className="btn-add-first" onClick={() => setModal('new')}>Nuevo combo</button>}
            </div>
          ) : (
            <>
